...
namespace gNox.BehaviorTreeVisualizer
{
    public class BehaviorTreeGraphWindow : EditorWindow
    {
        ...
        public static readonly string c_RootPath = "Assets/RogueLike/Scripts/Enemy/BehaviorTree/Editor";
        public static readonly string c_RootPathData = "Assets/RogueLike/Scripts/Enemy/BehaviorTree/Behavior Tree Visualizer (Beta)";
        public static readonly string c_WindowsPath = $"{c_RootPath}/Windows";
