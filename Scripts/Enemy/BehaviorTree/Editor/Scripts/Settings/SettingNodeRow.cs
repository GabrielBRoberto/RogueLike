...
using static gNox.BehaviorTreeVisualizer.SettingsData;
...
namespace gNox.BehaviorTreeVisualizer
{
    ...
    public class SettingNodeRow : VisualElement
    {
        ...
        public SettingNodeRow(NodeProperty settings, SettingNodeType nodeType)
        {
            if (rowTemplate == null)
            {
                rowTemplate = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>($"{BehaviorTreeGraphWindow.c_WindowsPath}/setting_node_row.uxml");
            }
